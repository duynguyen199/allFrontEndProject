...
//Tren 3 phut moi tinh tien cho, cu 3 phut moi tinh mot lan /3 va lam tron
...
document.getElementById("btnInHD") = function () {
    var kg = getData();
    var tongTien = tinhTongTien();
    var loaiXe = kiemTraLoaiXe();
    switch (loaiXe) {
